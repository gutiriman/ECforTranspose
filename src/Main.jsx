      ...
      <div>
         ...
         <div className="contact">
            <div className="step">
               ...
               <p>右記フォームまたはヘッダ部のメールお問合せにて、楽譜移調に関するご要望をお送りください。その際、移調希望の楽譜がある場合は添付をお願いいたします。<br />
                  ※添付ファイルはPDF、または写真や画像データでも問題ございません。
               </p>
               <h3 className="circle">2</h3>
               <p>お問い合わせいただいた内容をもとに、お見積り結果とクレジットカード決済用のリンクを送付させていただきます。<br />（決済はPayPayでも可能ですのでお申しつけください。）</p>
